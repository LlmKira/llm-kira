...
class LangCode(object):
    """
    Language code class
    convert language code to language name or language name to language code
    """
    ...
    @property
    def languages_code(self) -> dict:
        """
        :return: dict
        """
        return self.LANGUAGES_CODE

    # 将语言代码转换为语言名称
    def convert(self, lang_code) -> str:
        """
        :param lang_code: str
        :return: str
        """
        ...
        return self.LANGUAGES_CODE.get(lang_code, "unknown")

    # 将语言名称转换为语言代码
    def reverse_convert(self, lang_name) -> str:
        """
        :param lang_name: str
        :return: str
        """
        ...
        return {v: k for k, v in self.LANGUAGES_CODE.items()}.get(lang_name, "unknown")
